...
**Este proyecto desarrollado para un ambito personal y originalmente ser una retroalimentación** entre desarrolladores de software Android,Java. Proyecto hecho por [@CristianDevOps](https://www.facebook.com/cristian.va.5688/). con las intenciones autenticas de aprender el lenguaje **Java-Android(Android Studio SDK,API, BIBLOTECA HTTP)** y a la par, realizar procesos aplicable, que puedan ser compartidos y utilizados con la finalidad de compartir conocimientos sobre programación.
